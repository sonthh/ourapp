...
public class Exceptions {
    ...
    public static final String HEALTHY_STATUS_EXISTED = "Thông tin tình trạng sức khỏe tồn tại";
    public static final String HEALTHY_STATUS_NOT_FOUND = "Thông tin tình trạng sức khỏe chưa có";
